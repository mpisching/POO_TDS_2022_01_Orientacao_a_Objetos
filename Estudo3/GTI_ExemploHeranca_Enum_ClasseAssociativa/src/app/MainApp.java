...
public class MainApp {
    public static void main(String[] args) {
        ...
        cc1.depositar(100);
        Movimentacao m1 = new Movimentacao(100, new Date(), 
                        EOperacao.DEPOSITO, cc1);
        historico.add(m1);
        cc1.sacar(500);
        Movimentacao m2 = new Movimentacao(500, new Date(), 
                        EOperacao.SAQUE, cc1);
        historico.add(m2);
        
        imprimir(historico, cc1);
        
        //movimentacoes cliente 2
        cc2.depositar(1000);
        Movimentacao m3 = new Movimentacao(1000, new Date(), 
                        EOperacao.DEPOSITO, cc2);
        historico.add(m3);
        cc1.sacar(600);
        //Movimentacao m4 = new Movimentacao(600, new Date(), 
         //               EOperacao.SAQUE, cc2);
        //historico.add(m4);
        
        imprimir(historico, cc2);
    ...
    public static void imprimir(Historico historico, CartaoCredito cc) {
        List<Movimentacao> movimentos = historico.getMovimentos(cc);
