...
public class Cliente {
    ...
    public String getDados() {
        ...
        sb.append("Status.........: ").append(this.status.getCodigo()).append(" - ").
                append(sb).append(this.status.getDescricao()).append("\n");
        sb.append("========= Cartões ==========").append("\n");
        if (cartoes != null && !cartoes.isEmpty()) {
            for (CartaoCredito cartao : cartoes) {
                sb.append(cartao.getDados());
//                sb.append("1 - ").append(cartao.getNumero()).append(" Validade ").
//                        append(cartao.getDataValidade()).append("  R$ ").
//                        append(cartao.getSaldo()).append("\n");
            }
        } else {
